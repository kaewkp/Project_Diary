...
public class PaymentHistoryRepository {
        ...
        private void insertData(SQLiteDatabase db, String id, String name, String desc, String price, String date, String endDate, String datePay, String finish){
...
//        initialValues.put(History_id, id);
            ...
            initialValues.put(Payment_History.Column.History_datePay, datePay);
